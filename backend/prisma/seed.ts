...
async function main() {
  ...
  await prisma.textChunk.upsert({
    where: { id: 1 },
    update: {},
    create: {
      id: 1,
      text: "The old prince dressed ",
      isSelected: false,
      poemId: 1,
    },
  });
